...
```{r}
# join county_landcover and classes
...
# could also use qtm
# qtm(county_landcover, fill = NLCD.Land.Cover.Class)
```
...
# only works when I load in data from 01_spatial_intro
class(occ_prj)
class(co_elevation)

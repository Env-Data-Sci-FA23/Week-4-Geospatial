...
nm_elevation <- rast(nm_elevation)
```
...
```{r}
santafe_county <- nm_counties %>%
  filter(NAME == "Santa Fe")

santafe_elevation <- crop(nm_elevation, santafe_county, mask = TRUE)

qtm(santafe_county, fill = NULL)+
  qtm(santafe_elevation)
```
